"""
Management command to populate test data with Arabic names and transactions
"""
...
class Command(BaseCommand):
    help = 'Populates the database with test data including Arabic names and transactions'
    ...
    def handle(self, *args, **options):
        ...
        for user_data in editor_users:
            ...
            if created:
                self.stdout.write(f'Created editor: {user.email}')
